            ...
            >
              ...
              <div className="flex items-start w-full h-[94px] space-x-2">
                <div className="w-[50%] h-full flex flex-col justify-end space-y-2">
                  <label className="text-textBody text-[18px] font-medium">First name</label>
                  <input
                    type="text"
                ...
                <div className="w-[50%] h-full justify-end flex flex-col space-y-2">
                  <label className="text-textBody text-[18px] font-medium">Last name</label>
                  <input
                    type="text"
              ...
              <div className="w-full flex flex-col space-y-2">
                <label className="text-textBody text-[18px] font-medium">Email</label>
                <input
                  type="text"
                  placeholder="Email"
                  className="px-4 py-3 rounded-[10px] outline-none"
              ...
              {/* Phone Number */}
              <div className="w-full flex flex-col space-y-2">
                <label className="text-textBody text-[18px] font-medium">Phone number</label>
                <input
                  type="text"
              ...
              {/* Date */}
              <div className="w-full flex flex-col space-y-2">
                <label className="text-textBody text-[18px] font-medium">Select Date</label>
                <input
                  type="Date"
                  className="px-4 py-3 rounded-[10px] outline-none"
                  style={{ border: "1px solid rgba(208, 213, 221, 1)" }}
              ...
              <div className="w-[50%] flex flex-col space-y-2">
                <label className="text-textBody text-[18px] font-medium">Blood group</label>
                <input
                  type="text"
